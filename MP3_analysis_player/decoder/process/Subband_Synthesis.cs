...
namespace MP3_analysis_player.decoder.process
{
    class Subband_Synthesis
    {
        ...
        /// </summary>
        public Subband_Synthesis(int channelIndex, float factor)
        {
            InitBlock();
            if (d == null)
            {
        ...
        private void compute_pcm_samples0(Buffer buffer)
        {
            float[] vp = actual_v;
            //int inc = v_inc;
        ...
        private void compute_pcm_samples1(Buffer buffer)
        {
            float[] vp = actual_v;
            //int inc = v_inc;
            float[] tmpOut = _tmpOut;
        ...
        private void compute_pcm_samples2(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples3(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples4(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples5(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples6(Buffer buffer)
        {
            float[] vp = actual_v;
            float[] tmpOut = _tmpOut;
            int dvp = 0;
        ...
        private void compute_pcm_samples7(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples8(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples9(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples10(Buffer buffer)
        {
            float[] vp = actual_v;
            //int inc = v_inc;
            float[] tmpOut = _tmpOut;
        ...
        private void compute_pcm_samples11(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples12(Buffer buffer)
        {
            float[] vp = actual_v;
            //int inc = v_inc;
            float[] tmpOut = _tmpOut;
        ...
        private void compute_pcm_samples13(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples14(Buffer buffer)
        {
            float[] vp = actual_v;
        ...
        private void compute_pcm_samples15(Buffer buffer)
        {
            float[] vp = actual_v;
